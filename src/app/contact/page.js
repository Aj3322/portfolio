...
export default function Contact() {
  ...
  return (
    <Layout title="Contact Me | Ajay Kumar" description="Get in touch with Ajay Kumar">
      <div className="flex flex-col items-center justify-center min-h-screen py-12">
        <div className="w-full max-w-2xl bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700">
